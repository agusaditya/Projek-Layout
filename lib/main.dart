                ...
                Container(
                  ...
                  child: Row(
                    children: <Widget>[
                      Column(
                        children: <Widget>[
                          ContainIcon(0,"Singaraja",Icons.location_searching, Colors.black),     
                          ContainIcon(12,"Jazz",Icons.music_note, Colors.black),
                        ],),
                      Column(
                        children: <Widget>[
                          ContainIcon(0,"Suwug",Icons.store, Colors.black),
                          ContainIcon(12,"Undiksha",Icons.school, Colors.black),
                        ],
                      ),
                      ], 
                    ), 
